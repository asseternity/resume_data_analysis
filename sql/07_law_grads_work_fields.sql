SELECT
    ...
    CASE
        ...
        OR edu.program LIKE '%backend%'
        OR edu.program LIKE '%back end%'
        OR edu.program LIKE '%back-end%'
        OR edu.program LIKE '%frontend%'
        OR edu.program LIKE '%front end%'
        OR edu.program LIKE '%front-end%'
    ...
    END AS 'degree',
    CASE
        WHEN exp.title LIKE '%senior%' THEN "Senior"
        WHEN  exp.title LIKE '%junior%' THEN "Junior"
        ELSE "Other"
    END AS 'level'
FROM
